...
class TestSensei(unittest.TestCase):
    ...
    def test_that_nothing_is_returned_as_sorted_result_if_there_are_no_relevent_failures(
        self,
    ):
        self.sensei.failures = [
            (
                AboutTheKnightsWhoSayNi(),
                "File 'about_the_knights_whn_say_ni.py', line 24",
            ),
    ...
    def test_that_nothing_is_returned_as_sorted_result_if_there_are_3_shuffled_results(
        self,
    ):
        self.sensei.failures = [
    ...
    def test_that_it_will_choose_not_find_anything_with_non_standard_error_trace_string(
        self,
    ):
        self.sensei.failures = [
    ...
    def test_that_it_will_choose_correct_first_result_with_lines_9_and_27(self):
        ...
        self.assertEqual(
            "File 'about_trebuchets.py', line 9", self.sensei.firstFailure()[1]
        )
    ...
    def test_that_it_will_choose_correct_first_result_with_multiline_test_classes(self):
        ...
        self.assertEqual(
            "File 'about_giant_feet.py', line 44", self.sensei.firstFailure()[1]
        )
    ...
    def test_that_scraping_the_assertion_error_with_assert_true(self):
        self.assertEqual(
            "  AssertionError", self.sensei.scrapeAssertionError(error_assertion_true)
        )
  ...
  ?     ^""",
    ...
    def test_that_if_there_are_0_successes_it_will_say_the_first_zen_of_python_koans(
        self,
    ):
    ...
    def test_that_if_there_is_1_success_it_will_say_the_second_zen_of_python_koans(
        self,
    ):
    ...
    def test_that_if_there_are_10_successes_it_will_say_the_sixth_zen_of_python_koans(
        self,
    ):
    ...
    def test_that_if_there_are_36_successes_it_will_say_the_final_zen_of_python_koans(
        self,
    ):
    ...
    def test_that_if_there_are_37_successes_it_will_say_the_first_zen_of_python_koans_again(
        self,
    ):
    ...
    def test_filter_all_lessons_will_discover_test_classes_if_none_have_been_discovered_yet(
        self,
    ):
